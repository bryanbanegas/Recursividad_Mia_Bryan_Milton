...
public class Login extends javax.swing.JFrame {
    ...
    private void IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarActionPerformed
        ...
        if(usuarioLogin.equals("admin")){
            if(contraseñaLogin.equals("supersecreto")){
            ...
            for(int indice=0;indice<llamar.users.length;indice++){
                if(llamar.users[indice].getUser().equals(usuarioLogin)){
                    if(llamar.users[indice].getPassword().equals(contraseñaLogin)){
                        Sistema pasar=new Sistema();
                        pasar.setVisible(true);
                        this.setVisible(false);
                        pos=indice;
